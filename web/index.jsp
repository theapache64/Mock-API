    ...
    <script>
        ...
        %>
            ...
            function generateTypeScript(isClass) {
                ...
                if (selection.trim().length > 0) {
                    ...
                    $("input#iTargetLang").val(isClass
                        ? '<%=JsonToModelEngine.LANGUAGE_TYPESCRIPT_CLASS%>'
                        : '<%=JsonToModelEngine.LANGUAGE_TYPESCRIPT_INTERFACE%>');
                    $("input#iRouteName").val($("input#route").val());
                    $("form#fJsonToModel").submit();
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (!data.error) {
                                ...
                                $("input#statusCode").val(data.data.status_code)
            ...
            $("button#bSubmit").on('click', function () {
                ...
                var statusCode = $("input#statusCode").val();
                ...
                $.ajax({
                    ...
                    data: params +
                        ...
                        "&status_code=" + encodeURIComponent(statusCode) +
            ...
            function startLoading(isSubmit) {
                ...
                $("input#statusCode").prop('disabled', true);
            ...
            function stopLoading(isSubmit) {
                ...
                $("input#statusCode").prop('disabled', false);
        ...
        <div class="col-md-12">
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    ...
                    <input class="form-control" type="number" placeholder="Status Code" id="statusCode"/>
                        ...
                        <form class="form-inline">
                            <div class="form-group">
                                <select id="responses" class="form-control">
                                    <option value="<%=Routes.COLUMN_DEFAULT_RESPONSE%>">Default
                                        response
                                    </option>
                                </select>
                            </div>
                ...
                <div class="modal-body">
                    ...
                    <form id="fInsertImage" style="width: 0px;height: 0px;overflow: hidden">
                        <input id="iFile" type="file" accept="image/*"
                               name="<%=UploadImageServlet.KEY_IMAGE%>"
                               required/>
